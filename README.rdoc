...
Browser pushState is used to have non-hashed real links. App is not properly Restful though as JS code needs to run in the browser to display the correct results. Should 'feel' Restful, for in browser usage. Tested in Chrome Version 39.0.2171.95m and 
